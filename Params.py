...
#---------Tmall--------------------------------------------------------------------------------------------------------------
	...
	# parser.add_argument('--opt_weight_decay', default=1e-3, type=float, help='weight decay regularizer')
	# parser.add_argument('--prop_opt_base_lr', default=1e-5, type=float, help='learning rate')
	# parser.add_argument('--prop_opt_max_lr', default=2e-3, type=float, help='learning rate')
	...
	# parser.add_argument('--drop_rate1', default=0.3, type=float, help='drop_rate')  
	# parser.add_argument('--seed', type=int, default=6)  
	# parser.add_argument('--slope', type=float, default=0.2)  
	# parser.add_argument('--patience', type=int, default=100)

	# parser.add_argument('--neg_rate', type=float, default=0.05)
	# # #for save and read
	# parser.add_argument('--path', default='/home/tykim75/TY_model/datasets/', type=str, help='data path')
	# parser.add_argument('--save_path', default='tem', help='file name to save model and training record')
	# parser.add_argument('--load_model', default=None, help='model name to load')
	# parser.add_argument('--target', default='buy', type=str, help='target behavior to predict on')
	# parser.add_argument('--isload', default=True , type=bool, help='whether load model')  
	...
	# parser.add_argument('--loadModelPath', default='/home/tykim75/TY_model/Model/Tmall/for_meta_hidden_dim_dim__8_Tmall_2023_04_12__04_58_40_lr_0.001_reg_0.001_batch_size_8192_gnn_layer_[16,16,16].pth', type=str, help='loadModelPath')
	
	# return parser.parse_args()
	#parser.add_argument('--loadModelPath', default='/home/tykim75/Code/work3/BSTRec/Model/Tmall/for_meta_hidden_dim_dim__8_Tmall_2021_07_08__01_35_54_lr_0.0003_reg_0.001_batch_size_4096_gnn_layer_[16,16,16].pth', type=str, help='loadModelPath')
